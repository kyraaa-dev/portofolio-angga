...
<body>
    ...
    <section class="orbit-section container reveal delay-2">
        <div class="section-header reveal">
            <h2 class="section-title text-reveal" data-i18n="tech_title">Tech <span class="highlight">Ecosystem</span></h2>
    ...
    <section id="services" class="services container reveal">
        <div class="section-header reveal">
            <h2 class="section-title text-reveal" data-i18n="services_title">What I <span class="highlight">Do</span></h2>
    ...
    <section id="experience" class="experience container reveal">
        <div class="section-header reveal">
            <h2 class="section-title text-reveal" data-i18n="exp_title">My <span class="highlight">Journey</span></h2>
                ...
                if (translations[key] && translations[key][lang]) {
                    ...
                    setTimeout(() => {
                        ...
                        if (el.classList.contains('text-reveal')) {
                            el.innerHTML = `<span class="line-reveal-wrapper"><span class="line-reveal-inner">${text}</span></span>`;
                        } else {
                            el.innerHTML = text;
                        }
                        el.style.opacity = '1';
                        // Re-trigger reveal animation if already active
