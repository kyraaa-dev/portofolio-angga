    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 768px) {
            ...
            .mobile-overlay-footer { display: flex; gap: 24px; opacity: 0; transform: translateY(20px); transition: all 0.5s ease; }
    ...
    <div class="mobile-overlay" id="mobileOverlay">
        ...
        <div class="mobile-overlay-content">
            ...
            <div class="mobile-overlay-footer">
                ...
                <a href="https://kyraaadev.pages.dev/#" target="_blank" rel="noopener noreferrer" class="mobile-social">
