...
<body>
    ...
    <div class="mobile-overlay" id="mobileOverlay">
        ...
        <div class="mobile-overlay-content">
            ...
            <nav class="mobile-nav-list">
                <div class="mobile-nav-item"><a href="#" class="mobile-link" data-i18n="nav_home">Home</a></div>
                <div class="mobile-nav-item"><a href="#projects" class="mobile-link" data-i18n="nav_projects">Proyek</a></div>
                <div class="mobile-nav-item"><a href="#contact" class="mobile-link" data-i18n="nav_contact">Kontak</a></div>
            </nav>
    ...
    <!-- Lenis Smooth Scroll Removed for Native Performance -->
