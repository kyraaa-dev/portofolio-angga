        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 768px) {
            ...
            .nav-links {
                ...
                background: rgba(10, 15, 25, 0.98); backdrop-filter: blur(20px); -webkit-backdrop-filter: blur(20px);
                z-index: 999; opacity: 0; pointer-events: none; transition: opacity 0.5s ease;
                gap: 32px; margin: 0; padding: 0 10vw;
            }
            [data-theme="light"] .nav-links { background: rgba(255, 255, 255, 0.98); }
            .nav-links.active { opacity: 1; pointer-events: auto; }
            
            .nav-links .nav-link { 
                font-size: 44px; font-weight: 300; letter-spacing: -0.04em; color: var(--text-primary); text-transform: lowercase; 
                opacity: 0; transform: translateX(-40px); transition: opacity 0.5s ease, transform 0.5s cubic-bezier(0.165, 0.84, 0.44, 1); 
                display: flex; align-items: center;
            }
            .nav-links .nav-link::before {
                content: ''; display: inline-block; width: 8px; height: 8px; background: var(--accent-color); border-radius: 50%; 
                margin-right: 20px; opacity: 0; transform: translateX(-10px); transition: all 0.3s ease;
            }
            .nav-links .nav-link:hover::before { opacity: 1; transform: translateX(0); }
            
            .nav-links.active .nav-link { opacity: 1; transform: translateX(0); }
            .nav-links.active .nav-link:nth-child(1) { transition-delay: 0.15s; }
            .nav-links.active .nav-link:nth-child(2) { transition-delay: 0.25s; }
            .nav-links.active .nav-link:nth-child(3) { transition-delay: 0.35s; }
